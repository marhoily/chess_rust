...
pub fn parse_board88(input: &[u8]) -> IResult<&[u8], BitBoard88, ParsingError> {
...
mod test {
    ...
    fn check(fen: &str) {
        let parse = parse_board88(fen.as_bytes());
        if parse.is_err() {
